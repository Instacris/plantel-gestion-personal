/* ============================================================
   PLANTEL · Semilla del modo DEMOSTRACIÓN (solo en el navegador)

   Copia de api/_lib/seed.js para que la cuenta demo funcione
   100% en el navegador, SIN tocar la base de datos compartida.
   Así, quien mire el portafolio puede probar el sistema (agregar,
   editar, borrar trabajadores) sin afectar a nadie: sus cambios
   viven solo en su navegador y se pueden reiniciar cuando quiera.
   ============================================================ */
(function () {
  "use strict";

  /* Arma el horario semanal desde una spec compacta: días no listados = libres */
  function H(spec) {
    const h = {};
    for (let d = 1; d <= 7; d++) {
      const s = spec[d];
  ...
  const CONTRATOS = [
    { id: "ct-interna",    nombre: "Empresa Interna (Planta)", tipo: "Contrato indefinido",    color: "#c2410c", sueldoBase: 720000, factorExtra: 1.5, jornadaSemanal: 44, turnoDefecto: "Mañana",   descripcion: "Personal de planta con contrato directo e indefinido." },
  ...
  const TRABAJADORES = [
    { id: "t1",  nombre: "María González",   rut: "18.452.114-2", cargo: "Jefa de Turno",         rol: "Supervisor",    contratoId: "ct-interna",    turno: "Mañana",   estado: "Activo",     color: "#c2410c", ingreso: "2021-03-15", sueldoBase: 920000,  valorHoraExtra: 7700, horasExtrasMes: 6,  horario: H({1:["08:00","17:00"],2:["08:00","17:00"],3:["08:00","17:00"],4:["08:00","17:00"],5:["08:00","16:00"]}), asistencia: {} },
  ...
  window.PLANTEL_DEMO_SEED = { contratos: CONTRATOS, trabajadores: TRABAJADORES };
})();
